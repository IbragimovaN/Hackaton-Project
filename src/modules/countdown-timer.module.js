...
export class CountDownTimerModule extends Module {
  ...
  renderTimerBlock() {
    ...
    startBtnTimerBlock.addEventListener("click", () =>
      this.#startTimer(inputTimerBlock)
    );
    ...
    stopBtnTimerBlock.addEventListener("click", () =>
  ...
  #startTimer(input) {
    ...
    textMotivation.textContent =
      "Пока идёт таймер. Ты можешь сделать, например, планку :)";
